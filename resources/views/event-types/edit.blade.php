    ...
    <div class="max-w-xl mx-auto px-4 pt-4 pb-8">
        <div class="flex items-center justify-between mb-5">
            <div>
                ...
                <h2 class="font-display text-2xl md:text-3xl text-ink font-normal leading-tight mt-1">Edit Jenis Event</h2>
            </div>
        ...
        <div class="bg-cream border border-beige-deep rounded-lg p-6 md:p-8">
            <form method="POST" action="{{ route('admin.event-types.update', $eventType) }}" class="space-y-4">
                @csrf @method('PUT')
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="{{ old('slug', $eventType->slug) }}" required
                        class="w-full rounded-md border-hairline-strong bg-canvas text-sm text-ink px-3 py-2.5 focus:border-primary focus:ring-primary">
