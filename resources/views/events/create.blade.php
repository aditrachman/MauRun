        ...
        <div class="bg-cream border border-beige-deep rounded-lg p-6 md:p-8">
            <form method="POST" action="{{ route('admin.events.store') }}" enctype="multipart/form-data" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="custom-file-wrapper relative">
                        ...
                        <label for="image-input" class="flex items-center gap-3 w-full rounded-md border border-dashed border-beige-deep bg-canvas px-4 py-3 cursor-pointer hover:border-primary hover:bg-primary/5 transition group">
                            ...
                            <span class="flex-1 min-w-0">
                                <span class="file-label block text-sm font-medium text-charcoal">Pilih Gambar</span>
                                <span class="file-name block text-xs text-steel truncate mt-0.5">Tidak ada file dipilih</span>
                            </span>
                    ...
                    <p class="text-xs text-steel mt-2">Format: <strong class="text-charcoal">JPG, PNG, WEBP</strong> · Maks: <strong class="text-charcoal">2 MB</strong></p>
                ...
                <script>
                    document.getElementById('image-input')?.addEventListener('change', function(e) {
                        ...
                        if (this.files && this.files[0]) {
                            ...
                            name.textContent = 'Tidak ada file dipilih';
                        }
                    });
                </script>
